...
function AdminFeed() {
    ...
    async function remove(user) {
        ...
        let response = await fetch(
            `http://localhost:4000/users/deletefeed/${removeuser}`,
            {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                    ...
                    <div>
                        ...
                        >
                            ...
                            <CardBody>
                                ...
                                <Link to={{ pathname: "/admineditfeed", item: user }}>
                                    {" "}
